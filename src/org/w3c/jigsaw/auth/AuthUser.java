...
public class AuthUser extends Resource {
    ...
    static {
        ...
        a = new StringAttribute("email", null, Attribute.EDITABLE);
        ATTR_EMAIL = AttributeRegistry.registerAttribute(cls, a);
        a = new StringAttribute("comments", null, Attribute.EDITABLE);
        ATTR_COMMENTS = AttributeRegistry.registerAttribute(cls, a);
        a = new IPTemplatesAttribute("ipaddress", null, Attribute.EDITABLE);
        ATTR_IPADDR = AttributeRegistry.registerAttribute(cls, a);
        a = new PasswordAttribute("password", null, Attribute.EDITABLE);
     ...
     * @param name The user's name.
     */
    public static AuthUser makeUser(Resource res, String name, ResourceContext context) {
        Hashtable defs = new Hashtable(3);
        defs.put(id, name);
        defs.put(co, context);
