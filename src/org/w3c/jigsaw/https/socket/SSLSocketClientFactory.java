...
public class SSLSocketClientFactory extends SocketClientFactory {
	 ...
	 * unavailable
         */
        public Object getInstance(String algorithm) throws NoSuchAlgorithmException {
            try {
                return invoke("getInstance", new Class[] { String.class }, new Object[] { algorithm });
	 ...
	 *         cannot be recovered
        ...
        public void init(KeyStore ks, char[] password) throws KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException {
            try {
                invoke("init", new Class[] { KeyStore.class, char[].class }, new Object[] { ks, password });
	 ...
	 *                   (unavailable prior to JDK 1.4)
         ...
         */
        public void init(Object parameters) throws InvalidAlgorithmParameterException {
            try {
                invoke("init", new Class[] { Object.class }, new Object[] { parameters });
	 ...
	 *         is unavailable
        ...
        public void init(KeyStore ks) throws KeyStoreException {
            try {
                invoke("init", new Class[] { KeyStore.class }, new Object[] { ks });
            } catch (KeyStoreException ex) {
                throw ex;
            } catch (Exception ex) {
                RuntimeException rex = new RuntimeException(ex.toString());
	 ...
	 *                                  is not available
         */
        public Object getInstance(String protocol) throws NoSuchAlgorithmException {
            try {
                return invoke("getInstance", new Class[] { String.class }, new Object[] { protocol });
            } catch (NoSuchAlgorithmException ex) {
                throw ex;
            } catch (Exception ex) {
                RuntimeException rex = new RuntimeException(ex.toString());
         ...
         */
        public void init(Object km, Object tm, SecureRandom random) throws KeyManagementException {
            try {
                invoke("init", new Class[] { Object.class, Object.class, SecureRandom.class }, new Object[] { km, tm, random });
     ...
     */
    private static final class ManagerFactoryParametersFactory extends Delegator {
	 ...
	 *                                         is not available
         */
        public Object getInstance(String path, String password) throws InvalidAlgorithmParameterException, NoSuchMethodException {
            try {
                return invoke("getInstance", new Class[] { String.class, String.class }, new Object[] { path, password });
            } catch (InvalidAlgorithmParameterException ex) {
                throw ex;
	 ...
	 *         available
         */
        public Object getInstance(String path) throws InvalidAlgorithmParameterException, NoSuchMethodException {
            try {
                return invoke("getInstance", new Class[] { String.class }, new Object[] { path });
            } catch (InvalidAlgorithmParameterException ex) {
                throw ex;
            } catch (NoSuchMethodException ex) {
                throw ex;
    ...
    private static class Delegator {
        ...
        public Object invoke(String name, Class[] deftypes, Object[] args) throws Exception {
            int count = ((args != null) ? args.length : 0);
            Class[] types = new Class[count];
            Object[] param = new Object[count];
            edu.hkust.clap.monitor.Monitor.loopBegin(741);
for (int i = 0; i < count; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(741);
{
                Object arg = args[i];
                Class art = null;
                if (null != arg) {
                ...
                types[i] = ((null != art) ? art : ((null != deftypes) && (i < deftypes.length) ? deftypes[i] : Object.class));
                param[i] = arg;
            }} 
edu.hkust.clap.monitor.Monitor.loopEnd(741);
    ...
    static {
        ...
        try {
            ...
            implementationNamespace = (supported ? "javax.net.ssl." : "com.sun.net.ssl.");
        }
    }
    ...
    public ServerSocket createServerSocket() throws IOException {
        ...
        if (bindAddr == null) {
            ...
            serversocket = getFactory().createServerSocket(port, clients, bindAddr);
        }
        if (serversocket instanceof SSLServerSocket) {
            ObservableProperties props = daemon.getProperties();
            boolean mandatory;
            mandatory = props.getBoolean(SSLProperties.MUST_AUTHENTICATE_P, false);
            boolean generic;
            generic = props.getBoolean(SSLProperties.TRUSTSTORE_GENERIC_P, false);
            String trust;
            trust = props.getString(SSLProperties.TRUSTSTORE_PATH_P, null);
            boolean authenticate = mandatory || generic || ((null != trust) && (trust.length() > 0));
            if (authenticate) {
     ...
     *         instantiated
     */
    private static final void addProvider(String provider) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        if (null != provider) {
            if (null == Security.getProvider(provider)) {
                ...
                if (debug) {
                    System.out.println("Added new security provider: " + supplier.getInfo() + ".");
                }
            }
        }
    }
     ...
     */
    private static final KeyStore getStore(ObservableProperties props, String typekey, String pathkey, String passkey) throws KeyStoreException, IOException, NoSuchAlgorithmException, CertificateException {
        ...
        if ((null != storepath) || (null != storepass)) {
            String storetype = props.getString(typekey, KeyStore.getDefaultType());
            KeyStore store = KeyStore.getInstance(storetype);
            store.load((null != storepath) ? new BufferedInputStream(new FileInputStream(storepath)) : null, (null != storepass) ? storepass.toCharArray() : new char[0]);
            return store;
        } else {
            return null;
        }
     ...
     */
    private static final Object getParams(ObservableProperties props, String typekey, String pathkey, String passkey) throws InvalidParameterSpecException, InvalidAlgorithmParameterException, ClassNotFoundException {
        if (supportsOptionalClientAuth) {
            ...
            if ((null != paratype) && (paratype.length() > 0)) {
                ...
                Class managerFactoryParameters = Class.forName(implementationNamespace + "ManagerFactoryParameters");
     ...
     * @throws KeyManagementException  if initialization fails
     */
    private static final SSLContext createContext(ObservableProperties props) throws ClassNotFoundException, KeyStoreException, IOException, NoSuchAlgorithmException, InvalidParameterSpecException, InvalidAlgorithmParameterException, CertificateException, UnrecoverableKeyException, InstantiationException, IllegalAccessException, InvocationTargetException, KeyManagementException {
        Class keyManagerFactory = Class.forName(implementationNamespace + "KeyManagerFactory");
        Class trustManagerFactory = Class.forName(implementationNamespace + "TrustManagerFactory");
        Class sslContext = Class.forName(implementationNamespace + "SSLContext");
        ...
        Object kmfload = kmfboot.getInstance((null != kmftype) ? kmftype : kmfboot.getDefaultAlgorithm());
        KeyManagerFactory kmf = new KeyManagerFactory(kmfload);
        boolean kgen = props.getBoolean(SSLProperties.KEYSTORE_GENERIC_P, SSLProperties.DEFAULT_KEYSTORE_GENERIC);
        if (kgen) {
            Object kmfp = getParams(props, SSLProperties.TRUSTSTORE_TYPE_P, SSLProperties.TRUSTSTORE_PATH_P, SSLProperties.TRUSTSTORE_PASSWORD_P);
            kmf.init(kmfp);
        } else {
            KeyStore ks = getStore(props, SSLProperties.KEYSTORE_TYPE_P, SSLProperties.KEYSTORE_PATH_P, SSLProperties.KEYSTORE_PASSWORD_P);
            String keypass = props.getString(SSLProperties.KEYSTORE_PASSWORD_P, null);
            kmf.init(ks, (null != keypass ? keypass.toCharArray() : new char[0]));
        }
        TrustManagerFactory tmfboot;
        tmfboot = new TrustManagerFactory(trustManagerFactory);
        String tmftype = props.getString(SSLProperties.TRUSTMANAGER_TYPE_P, null);
        Object tmfload = tmfboot.getInstance((null != tmftype) ? tmftype : tmfboot.getDefaultAlgorithm());
        TrustManagerFactory tmf = new TrustManagerFactory(tmfload);
        boolean tgen = props.getBoolean(SSLProperties.TRUSTSTORE_GENERIC_P, SSLProperties.DEFAULT_TRUSTSTORE_GENERIC);
        if (tgen) {
            Object tmfp = getParams(props, SSLProperties.TRUSTSTORE_TYPE_P, SSLProperties.TRUSTSTORE_PATH_P, SSLProperties.TRUSTSTORE_PASSWORD_P);
            tmf.init(tmfp);
        } else {
            KeyStore ts = getStore(props, SSLProperties.TRUSTSTORE_TYPE_P, SSLProperties.TRUSTSTORE_PATH_P, SSLProperties.TRUSTSTORE_PASSWORD_P);
            tmf.init(ts);
        }
        String protocol = props.getString(SSLProperties.PROTOCOL_NAME_P, SSLProperties.DEFAULT_PROTOCOL_NAME);
    ...
    public void initialize(httpd server) {
        ...
        try {
            String provider;
            provider = props.getString(SSLProperties.SECURITY_PROVIDER_P, (supportsOptionalClientAuth ? null : SSLProperties.DEFAULT_SECURITY_PROVIDER));
            addProvider(provider);
            String handler = props.getString(SSLProperties.PROTOCOL_HANDLER_P, (supportsOptionalClientAuth ? null : SSLProperties.DEFAULT_PROTOCOL_HANDLER));
            setHandler(handler);
            ...
            try {
                if (name.equals(MAXCLIENTS_P)) {
                    ...
                    if (newmax > maxClients) {
                        edu.hkust.clap.monitor.Monitor.loopBegin(742);
for (int i = maxClients - newmax; --i >= 0; ) { 
edu.hkust.clap.monitor.Monitor.loopInc(742);
{
                            addClient(true);
                        }} 
edu.hkust.clap.monitor.Monitor.loopEnd(742);
                    ...
                    return true;
                } else if ((name.equals(SSLProperties.KEYSTORE_GENERIC_P)) || (name.equals(SSLProperties.KEYSTORE_PATH_P)) || (name.equals(SSLProperties.KEYSTORE_TYPE_P)) || (name.equals(SSLProperties.KEYSTORE_PASSWORD_P)) || (name.equals(SSLProperties.TRUSTSTORE_GENERIC_P)) || (name.equals(SSLProperties.TRUSTSTORE_PATH_P)) || (name.equals(SSLProperties.TRUSTSTORE_TYPE_P)) || (name.equals(SSLProperties.TRUSTSTORE_PASSWORD_P)) || (name.equals(SSLProperties.PROTOCOL_NAME_P))) {
                    context = createContext(props);
                    return true;
                } else {
                    return true;
    ...
    private ServerSocketFactory getFactory() throws SSLKeyException {
        ...
        factory = ((null != context) ? context.getServerSocketFactory() : SSLServerSocketFactory.getDefault());
        String[] supported = ((SSLServerSocketFactory) factory).getSupportedCipherSuites();
        if (debug) {
            System.out.println("Supported suites:");
            edu.hkust.clap.monitor.Monitor.loopBegin(743);
for (int i = 0; i < supported.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(743);
{
                System.out.println("          " + supported[i]);
            }} 
edu.hkust.clap.monitor.Monitor.loopEnd(743);

            String[] enabled = ((SSLServerSocketFactory) factory).getDefaultCipherSuites();
            System.out.println("Enabled suites:");
            edu.hkust.clap.monitor.Monitor.loopBegin(744);
for (int i = 0; i < enabled.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(744);
{
                System.out.println("         " + enabled[i]);
            }} 
edu.hkust.clap.monitor.Monitor.loopEnd(744);

        }
        if (supported.length < 1) {
            SSLKeyException ex = new SSLKeyException("No cipher suites supported by this " + "SSL socket factory. " + "Please check your factory, key store, " + "store password and cerificates");
