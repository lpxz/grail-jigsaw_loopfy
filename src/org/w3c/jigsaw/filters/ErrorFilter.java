...
public class ErrorFilter extends ResourceFilter {
    ...
    static {
        ...
        a = new StringAttribute("base-url", "/errors", Attribute.EDITABLE);
        ATTR_BASEURL = AttributeRegistry.registerAttribute(cls, a);
        a = new StringAttribute("extension", "html", Attribute.EDITABLE);
    ...
    public ReplyInterface outgoingFilter(RequestInterface req, ReplyInterface rep) throws ProtocolException {
        ...
        if (request.hasState(ERRED)) return null;
     ...
     */
    public ReplyInterface exceptionFilter(RequestInterface request, ProtocolException ex, FilterInterface filters[], int idx) {
