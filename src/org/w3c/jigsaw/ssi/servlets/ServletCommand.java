...
public class ServletCommand implements Command {
    ...
    protected static Hashtable wrappers = null;

    static {
        wrappers = new Hashtable(10);
    }

    protected void addParam(Dictionary d, String name, String param, String value) {
    ...
    public Reply execute(SSIFrame ssiframe, Request request, ArrayDictionary parameters, Dictionary variables) {
        ...
        if (name != null) {
            ...
            if (code != null) {
                ResourceReference r_wrapper = (ResourceReference) wrappers.get(code);
                if (r_wrapper == null) {
                    httpd server = (httpd) ssiframe.getFileResource().getServer();
                    ...
                    try {
                        ...
                        if (root.lookup(ls, lr)) wrap = lr.getTarget();
                        if (wrap != null) {
                            try {
                ...
                if (r_wrapper != null) {
                    ...
                    try {
                        FramedResource wrapper = (FramedResource) r_wrapper.lock();
