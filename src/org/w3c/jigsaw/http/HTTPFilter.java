...
public interface HTTPFilter {
     ...
     */
    public Reply ingoingFilter(Request request, HTTPFilter filters[], int fidx) throws ProtocolException;
     ...
     * @exception ProtocolException If the filter fails.
     */
    public Reply outgoingFilter(Request request, Reply reply, HTTPFilter filters[], int fidx) throws ProtocolException;

    public OutputStream outputFilter(Request request, Reply reply, OutputStream output) throws IOException;
     ...
     * @param fidx The index in the above array of the filter being called.
     */
    public Reply exceptionFilter(Request request, ProtocolException ex, HTTPFilter filters[], int fidx);
}
