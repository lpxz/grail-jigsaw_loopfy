...
public class ControlResource extends AbstractContainer {
    ...
    protected void saveProperties() {
        ...
        if (propfile == null) {
            throw new RuntimeException("Unable to save properties: property " + httpd.PROPS_P + " undefined.");
        } else {
            try {
    ...
    private String computeHelpUrl() {
        try {
            ...
            URL docurl = new URL(url.getProtocol(), url.getHost(), url.getPort(), "/Doc/Overview.html");
