...
public class PassDirectory extends org.w3c.jigsaw.resources.DirectoryResource {
    ...
    static {
        ...
        a = new FileAttribute("pass-target", null, Attribute.EDITABLE);
    ...
    public void setValue(int idx, Object value) {
        ...
        if (idx == ATTR_IDENTIFIER) {
            ...
            if (!file.isAbsolute()) {
                File abs = new File(getServer().getRootDirectory(), file.toString());
    ...
    public File getDirectory() {
        ...
        if (dir == null) dir = super.getDirectory();
        return dir;
    }
    ...
    public void initialize(Object values[]) {
        ...
        if (target != null) setValue(ATTR_DIRECTORY, target);
    }
}
