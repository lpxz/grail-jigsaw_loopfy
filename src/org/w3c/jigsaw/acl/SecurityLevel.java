    ...
    public Principal getPrincipal(Request request, String algo) {
        ...
        switch(level) {
            ...
            case 1:
                ...
                try {
                    return new DigestAuthPrincipal(request, nonce, old_nonce, algo);
                } catch (InvalidAuthException ex) {
            ...
            default:
                ...
                try {
                    return new DigestQopAuthPrincipal(request, nonce, old_nonce, algo);
                } catch (InvalidAuthException ex) {
                    try {
                        return new DigestAuthPrincipal(request, nonce, old_nonce, algo);
        ...
        switch(level) {
            ...
            default:
                if (principal instanceof DigestQopAuthPrincipal) {
                    ...
                    String opaque = null;
                    try {
                        MessageDigest md = MessageDigest.getInstance(filter.getAlgorithm());
        ...
        switch(level) {
            ...
            default:
                if (request.hasState(AuthFilter.STATE_AUTHCONTEXT)) {
                    ...
                    dap = (DigestAuthPrincipal) request.getState(AuthFilter.STATE_AUTHCONTEXT);
                    if (dap.isStale()) {
    ...
    private SecurityLevel(AclFilter filter) {
        ...
        switch(level) {
            ...
            case 1:
                ...
                challenge.setAuthParameter("realm", "");
                challenge.setAuthParameter("domain", filter.getResource().getURLPath());
