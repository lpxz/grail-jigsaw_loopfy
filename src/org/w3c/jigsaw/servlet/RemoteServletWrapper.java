...
public class RemoteServletWrapper extends ServletWrapper {
    ...
    static {
        ...
        a = new StringAttribute("servlet-base", null, Attribute.EDITABLE | Attribute.MANDATORY);
    ...
    protected boolean launchServlet() throws ClassNotFoundException, ServletException {
        ...
        if (inited) {
            ...
            try {
                ...
                String msg = ("class \"" + getServletClass() + "\" loaded from " + getServletBase() + ", invalid format.");
                if (debug) {
                    er.printStackTrace();
                }
                getServer().errlog(this, msg);
            } catch (ClassNotFoundException ex) {
                String msg = ("class \"" + getServletClass() + "\" loaded from " + getServletBase() + ", not found.");
                if (debug) {
                    ex.printStackTrace();
                }
                getServer().errlog(this, msg);
