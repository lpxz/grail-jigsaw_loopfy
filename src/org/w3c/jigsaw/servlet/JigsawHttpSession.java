...
public class JigsawHttpSession implements HttpSession {
    ...
    public Enumeration getAttributeNames() {
        if (!isValid) throw new IllegalStateException("Invalid session");
        return values.keys();
    }
    ...
    public void invalidate() {
        ...
        edu.hkust.clap.monitor.Monitor.loopBegin(308);
while (names.hasMoreElements()) { 
edu.hkust.clap.monitor.Monitor.loopInc(308);
{
            String name = (String) (names.nextElement());
            removeValue(name);
        }} 
edu.hkust.clap.monitor.Monitor.loopEnd(308);
    ...
    public void putValue(String name, Object value) {
        ...
        if (value != null) {
            ...
            if (value instanceof HttpSessionBindingListener) valueBound((HttpSessionBindingListener) value, name);
        }
    }
    ...
    public void removeValue(String name) {
        ...
        if (value != null) {
            values.remove(name);
            if (value instanceof HttpSessionBindingListener) valueUnbound((HttpSessionBindingListener) value, name);
        }
    }
    ...
    public String[] getValueNames() {
        ...
        int i = 0;
        edu.hkust.clap.monitor.Monitor.loopBegin(309);
while (e.hasMoreElements()) { 
edu.hkust.clap.monitor.Monitor.loopInc(309);
{
            names[i++] = (String) e.nextElement();
        }} 
edu.hkust.clap.monitor.Monitor.loopEnd(309);
    ...
    public JigsawHttpSession(JigsawHttpSessionContext context, JigsawServletContext servletContext, Cookie cookie) {
