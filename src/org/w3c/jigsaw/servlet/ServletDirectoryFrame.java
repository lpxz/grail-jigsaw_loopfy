...
public class ServletDirectoryFrame extends HTTPFrame {
        ...
        if (dresource != null) {
            ...
            if (rr != null) {
                try {
                    ...
                    if (resource instanceof ServletWrapper) return ((ServletWrapper) resource).getServlet();
    ...
    public boolean isServletLoaded(String name) {
        if (dresource != null) {
            ...
            if (rr != null) {
                try {
                    Resource resource = rr.lock();
                    if (resource instanceof ServletWrapper) return ((ServletWrapper) resource).isServletLoaded();
                } catch (InvalidResourceException ex) {
                    return false;
                } finally {
                    rr.unlock();
    ...
    public Enumeration getServlets() {
        if (dresource != null) return new ServletEnumeration(this, dresource.enumerateResourceIdentifiers()); else return new ServletEnumeration(this, null);
    }
    ...
    public Enumeration getServletNames() {
        if (dresource != null) return new ServletNamesEnumeration(this, dresource.enumerateResourceIdentifiers()); else return new ServletNamesEnumeration(this, null);
    }
    ...
    public Object getAttribute(String name) {
        if (definesAttribute(name)) return getValue(name, null); else if (resource.definesAttribute(name)) return resource.getValue(name, null);
        return null;
    }
    ...
    protected HttpSessionContext getHttpSessionContext() {
        if (sessionContext == null) {
            ...
            if (sprops != null) sessionContext = sprops.getSessionContext();
        }
    ...
    protected ServletProps getServletProps() {
        ...
        return (ServletProps) server.getPropertySet(ServletProps.SERVLET_PROPS_NAME);
    }

    protected ServletContext getServletContext() {
        if (servletContext == null) {
            servletContext = new JigsawServletContext(getFrameReference(), getServer().getProperties());
            File tmp = new File(getServer().getTempDirectory(), String.valueOf(resource.getURLPath().hashCode()));
            tmp.mkdirs();
