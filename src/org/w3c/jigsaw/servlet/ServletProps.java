...
public class ServletProps extends PropertySet {
    ...
    static {
        ...
        a = new FileAttribute(SERVLET_LOG_FILE_P, null, Attribute.EDITABLE);
        ATTR_SERVLET_LOG_FILE = AttributeRegistry.registerAttribute(cls, a);
        a = new LongAttribute(SERVLET_SESSION_IDLE, new Long(1800000), Attribute.EDITABLE);
        ATTR_MAX_IDLE_TIME = AttributeRegistry.registerAttribute(cls, a);
        a = new LongAttribute(SERVLET_TIMEOUT, new Long(1800000), Attribute.EDITABLE);
        ATTR_SERVLET_TIMEOUT = AttributeRegistry.registerAttribute(cls, a);
        a = new IntegerAttribute(SERVLET_INSTANCEMAX, new Integer(0), Attribute.EDITABLE);
        ATTR_SERVLET_INSTANCEMAX = AttributeRegistry.registerAttribute(cls, a);
        a = new IntegerAttribute(SERVLET_MAX_SESSION, new Integer(1024), Attribute.EDITABLE);
        ATTR_SESSIONS_MAX = AttributeRegistry.registerAttribute(cls, a);
        a = new IntegerAttribute(SERVLET_SESSION_SWEEP, new Integer(30000), Attribute.EDITABLE);
        ATTR_SESSIONS_SWEEP = AttributeRegistry.registerAttribute(cls, a);
        a = new StringAttribute(SERVLET_COOKIE_NAME, DEFAULT_COOKIE_NAME, Attribute.EDITABLE);
        ATTR_SESSIONS_COOKIE_NAME = AttributeRegistry.registerAttribute(cls, a);
        a = new StringAttribute(SERVLET_COOKIE_PATH, "/", Attribute.EDITABLE);
        ATTR_SESSIONS_COOKIE_PATH = AttributeRegistry.registerAttribute(cls, a);
        a = new StringAttribute(SERVLET_COOKIE_DOMAIN, null, Attribute.EDITABLE);
        ATTR_SESSIONS_COOKIE_DOMAIN = AttributeRegistry.registerAttribute(cls, a);
        a = new StringAttribute(SERVLET_COOKIE_COMMENT, "Jigsaw Server Session Tracking Cookie", Attribute.EDITABLE);
        ATTR_SESSIONS_COOKIE_COMMENT = AttributeRegistry.registerAttribute(cls, a);
        a = new IntegerAttribute(SERVLET_COOKIE_MAXAGE, new Integer(-1), Attribute.EDITABLE);
        ATTR_SESSIONS_COOKIE_MAXAGE = AttributeRegistry.registerAttribute(cls, a);
        a = new BooleanAttribute(SERVLET_COOKIE_SECURE, Boolean.FALSE, Attribute.EDITABLE);
        ATTR_SESSIONS_COOKIE_NAME = AttributeRegistry.registerAttribute(cls, a);
    }
    ...
    public long getSessionsMaxIdleTime() {
        return ((Long) getValue(ATTR_MAX_IDLE_TIME, new Long(1800000))).longValue();
    }
    ...
    public int getMaxSessionsNumber() {
        return ((Integer) getValue(ATTR_SESSIONS_MAX, new Integer(1024))).intValue();
    }
    ...
    public JigsawHttpSessionContext getSessionContext() {
        if (sessionContext == null) sessionContext = new JigsawHttpSessionContext(server, this);
