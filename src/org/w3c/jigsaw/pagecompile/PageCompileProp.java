...
public class PageCompileProp extends PropertySet {
    ...
    static {
        ...
        a = new FileAttribute(PAGE_COMPILED_DIR, null, Attribute.EDITABLE);
        ATTR_PAGE_COMPILED_DIR = AttributeRegistry.registerAttribute(cls, a);
        a = new StringAttribute(PAGE_COMPILER_CLASS, "org.w3c.jigsaw.pagecompile.JDKCompiler", Attribute.EDITABLE);
