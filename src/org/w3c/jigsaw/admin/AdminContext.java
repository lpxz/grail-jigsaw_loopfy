...
public class AdminContext {
    ...
    protected String getContent(Reply reply) {
        try {
            ...
            edu.hkust.clap.monitor.Monitor.loopBegin(738);
while ((bis.read(b, 0, 256)) != -1) { 
edu.hkust.clap.monitor.Monitor.loopInc(738);
buffer.append(new String(b));} 
edu.hkust.clap.monitor.Monitor.loopEnd(738);
    ...
    protected Reply runRequest(Request request) throws RemoteAccessException {
        ...
        try {
            ...
            if ((type == null) || (type.match(conftype) < 0)) {
                ...
                if (content != null) throw new RemoteAccessException(content);
    ...
    public static void main(String args[]) {
        try {
            ...
            edu.hkust.clap.monitor.Monitor.loopBegin(739);
for (int i = 2; i < args.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(739);
child = child.loadResource(args[i]);} 
edu.hkust.clap.monitor.Monitor.loopEnd(739);
            ...
            if (cmd.equals("dump")) {
                ...
                if (!child.isContainer()) {
                    ...
                    edu.hkust.clap.monitor.Monitor.loopBegin(740);
for (int i = 0; i < e.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(740);
System.out.println("\t" + e[i]);} 
edu.hkust.clap.monitor.Monitor.loopEnd(740);
