...
public class HtmlLink {
    ...
    public String toString() {
        return "<LINK" + ((href != null) ? " HREF=\"" + href + "\"" : "") + ((rel != null) ? " REL=\"" + rel + "\"" : "") + ((rev != null) ? " REV=\"" + rel + "\"" : "") + ((type != null) ? " type=\"" + type + "\"" : "") + ((title != null) ? " TITLE=\"" + rel + "\"" : "") + ">\n";
    }
     ...
     * @param title, String title
     */
    public HtmlLink(String rev, String rel, String href, MimeType type, String title) {
        this.rev = rev;
        this.rel = rel;
        this.href = href;
        this.type = type.toString();
