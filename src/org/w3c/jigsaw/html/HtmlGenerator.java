...
class HtmlHead {
    ...
    public void addStyle(String style) {
        if (this.style == null) this.style = new HtmlStyle(style); else this.style.append(style);
    }
    ...
    public void addScript(String script) {
        if (this.script == null) this.script = new HtmlScript(script); else this.script.append(script);
    }
    ...
    public void addLink(HtmlLink link) {
        if (links == null) links = new Vector(4);
    ...
    public void addMeta(String name, String value) {
        if (meta == null) {
            meta = new StringBuffer("<meta http-equiv=\"" + name + "\" content=\"" + value + "\">");
        } else {
            meta.append("<meta http-equiv=\"" + name + "\" content=\"" + value + "\">");
        }
    }
    ...
    public String toString() {
        ...
        if (links != null) {
            edu.hkust.clap.monitor.Monitor.loopBegin(529);
for (int i = 0; i < links.size(); i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(529);
strlink.append(links.elementAt(i).toString());} 
edu.hkust.clap.monitor.Monitor.loopEnd(529);

        }
        return "<head>\n <title>" + title + "</title>\n" + ((meta != null) ? meta.toString() : "") + ((base != null) ? " <base href=\"" + base + "\">\n" : "") + strlink.toString() + ((script != null) ? script.toString() : "") + ((style != null) ? style.toString() : "") + "</head>";
    }
...
public class HtmlGenerator {
    ...
    public void appendAndEscape(String content) {
        edu.hkust.clap.monitor.Monitor.loopBegin(530);
for (int i = 0; i < content.length(); i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(530);
{
...
edu.hkust.clap.monitor.Monitor.loopEnd(530);
