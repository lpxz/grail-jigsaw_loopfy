...
public class DAVRequest extends Request implements WEBDAV {
    ...
    static {
        registerHeader(DEPTH_HEADER, "org.w3c.www.http.HttpString");
        registerHeader(DESTINATION_HEADER, "org.w3c.www.http.HttpString");
        registerHeader(IF_HEADER, "org.w3c.www.webdav.DAVIfList");
        registerHeader(LOCK_TOKEN_HEADER, "org.w3c.www.http.HttpString");
        registerHeader(OVERWRITE_HEADER, "org.w3c.www.http.HttpString");
        registerHeader(TIMEOUT_HEADER, "org.w3c.www.http.HttpTokenList");
    }

    public static final String depthToString(int depth) {
        switch(depth) {
            case DEPTH_0:
                return "0";
            case DEPTH_1:
    ...
    public boolean getOverwrite() {
        ...
        String overwrite = (value != null) ? (String) value.getValue() : null;
    ...
    public DAVReply makeDAVReply(int status) {
        DAVReply reply = new DAVReply(client, this, getMajorVersion(), getMinorVersion(), status);
