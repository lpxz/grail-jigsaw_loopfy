...
public class ProxyExtFrame extends ProxyFrame {
    ...
    public ReplyInterface perform(RequestInterface ri) throws org.w3c.tools.resources.ProtocolException, org.w3c.tools.resources.ResourceException {
        ...
        if ((cman != null) || (copt != null)) {
            ...
            if (extReply != null) return extReply;
            if ((cman != null) && (man == null)) {
                String method = request.getMethod();
                if (method.startsWith("M-")) request.setMethod(method.substring(2));
            }
        }
        reply = (Reply) super.perform(ri);
        if ((cman != null) || (copt != null)) return applyExtensions(reply, cman, copt);
        return reply;
    }
     ...
     * the request failed.
     */
    public Reply applyExtensions(Request request, HttpExtList cman, HttpExtList copt) throws org.w3c.tools.resources.ProtocolException {
        if (cman != null) {
            ...
            edu.hkust.clap.monitor.Monitor.loopBegin(288);
for (int i = 0; i < exts.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(288);
content.append("<li> " + exts[i].getName() + "\n");} 
edu.hkust.clap.monitor.Monitor.loopEnd(288);
     ...
     * the request failed.
     */
    public Reply applyExtensions(Reply reply, HttpExtList cman, HttpExtList copt) throws org.w3c.tools.resources.ProtocolException {
        return reply;
    }
}
