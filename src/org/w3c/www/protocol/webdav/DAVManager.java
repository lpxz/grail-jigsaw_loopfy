...
public class DAVManager extends HttpManager {
     ...
     */
    public DAVReply runDAVRequest(DAVRequest request) throws HttpException {
    ...
    public static void main(String args[]) {
        try {
            ...
            org.w3c.www.protocol.http.PropRequestFilter filter = new org.w3c.www.protocol.http.cookies.CookieFilter();
            filter.initialize(manager);
            org.w3c.www.protocol.http.PropRequestFilter pdebug = new org.w3c.www.protocol.http.DebugFilter();
            ...
            int cnt = 0;
            edu.hkust.clap.monitor.Monitor.loopBegin(558);
while ((cnt = in.read(buf)) > 0) { 
edu.hkust.clap.monitor.Monitor.loopInc(558);
System.out.print(new String(buf, 0, cnt));} 
edu.hkust.clap.monitor.Monitor.loopEnd(558);
