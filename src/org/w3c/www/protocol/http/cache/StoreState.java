...
public class StoreState extends AttributeHolder {
    ...
    static {
        ...
        a = new IntegerAttribute("current-generation", null, Attribute.COMPUTED);
        ATTR_CURRENT_GENERATION = AttributeRegistry.registerAttribute(c, a);
        a = new IntegerAttribute("nb-generation", null, Attribute.COMPUTED);
        ATTR_NB_GENERATION = AttributeRegistry.registerAttribute(c, a);
        a = new IntegerAttribute("entry-num", null, Attribute.COMPUTED);
        ATTR_ENTRY_NUM = AttributeRegistry.registerAttribute(c, a);
        a = new LongAttribute("byte-count", null, Attribute.COMPUTED);
        ATTR_BYTE_COUNT = AttributeRegistry.registerAttribute(c, a);
        a = new LongAttribute("store-count", null, Attribute.COMPUTED);
        ATTR_STORE_COUNT = AttributeRegistry.registerAttribute(c, a);
        a = new IntegerAttribute("cr-count", null, Attribute.COMPUTED);
     ...
     */
    public synchronized void notifyResourceAdded(CachedResource cr, long oldsize) {
     ...
     */
    public synchronized void notifyResourceReplaced(CachedResource cr, long oldsize) {
        long size = cr.getCurrentLength();
