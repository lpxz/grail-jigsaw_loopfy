...
public abstract class CachedResource extends AttributeHolder implements TeeMonitor, LRUAble {
    ...
    static {
        ...
        Class c = null;
        try {
            c = Class.forName("org.w3c.www.protocol.http.cache.CachedResource");
        } catch (Exception ex) {
            ex.printStackTrace();
            System.exit(1);
        }
        a = new StringAttribute(NAME_IDENTIFIER, null, Attribute.COMPUTED);
        ATTR_IDENTIFIER = AttributeRegistry.registerAttribute(c, a);
        a = new IntegerAttribute(NAME_CONTENT_LENGTH, null, Attribute.COMPUTED);
        ATTR_CONTENT_LENGTH = AttributeRegistry.registerAttribute(c, a);
        a = new IntegerAttribute(NAME_CURRENT_LENGTH, null, Attribute.COMPUTED);
        ATTR_CURRENT_LENGTH = AttributeRegistry.registerAttribute(c, a);
        a = new FileAttribute(NAME_FILE, null, Attribute.COMPUTED);
        ATTR_FILE = AttributeRegistry.registerAttribute(c, a);
        a = new IntegerAttribute("load-state", null, Attribute.COMPUTED);
        ATTR_LOAD_STATE = AttributeRegistry.registerAttribute(c, a);
        a = new StringAttribute("etag", null, Attribute.COMPUTED);
        ATTR_ETAG = AttributeRegistry.registerAttribute(c, a);
        a = new IntegerAttribute("status", null, Attribute.COMPUTED);
        ATTR_STATUS = AttributeRegistry.registerAttribute(c, a);
        a = new DateAttribute("reply-last-modified", null, Attribute.COMPUTED | Attribute.EDITABLE);
        ATTR_REPLY_LAST_MODIFIED = AttributeRegistry.registerAttribute(c, a);
        a = new DateAttribute("reply-date", null, Attribute.COMPUTED | Attribute.EDITABLE);
        ATTR_DATE = AttributeRegistry.registerAttribute(c, a);
        a = new StringAttribute("content-md5", null, Attribute.COMPUTED);
        ATTR_CONTENT_MD5 = AttributeRegistry.registerAttribute(c, a);
        a = new StringArrayAttribute("content-encoding", null, Attribute.COMPUTED);
        ATTR_CONTENT_ENCODING = AttributeRegistry.registerAttribute(c, a);
        a = new StringArrayAttribute("content-language", null, Attribute.COMPUTED);
        ATTR_CONTENT_LANGUAGE = AttributeRegistry.registerAttribute(c, a);
        a = new StringAttribute("location", null, Attribute.COMPUTED);
        ATTR_LOCATION = AttributeRegistry.registerAttribute(c, a);
        a = new StringArrayAttribute("vary", null, Attribute.COMPUTED);
        ATTR_VARY = AttributeRegistry.registerAttribute(c, a);
        a = new PropertiesAttribute("headers", null, Attribute.COMPUTED);
        ATTR_EXTRA_HEADERS = AttributeRegistry.registerAttribute(c, a);
        a = new PropertiesAttribute("conneg", null, Attribute.COMPUTED);
     ...
     * loading it entirely.
     */
    protected static String ATTR_DESCR[] = { NAME_IDENTIFIER, NAME_CURRENT_LENGTH, NAME_FILE };
