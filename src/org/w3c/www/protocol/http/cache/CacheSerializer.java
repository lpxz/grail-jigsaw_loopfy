...
public abstract class CacheSerializer {
     ...
     */
    public abstract void writeGeneration(CacheGeneration generation, Writer writer) throws IOException;
     ...
     */
    public abstract void writeGenerationList(CacheStore store) throws IOException;
     ...
     */
    public abstract CacheGeneration readGeneration(CacheGeneration generation, Reader reader) throws IOException;
     ...
     * @param reader, the Reader used to read this generation
     */
    public abstract CacheGeneration readDescription(CacheGeneration generation, Reader reader) throws IOException;
     ...
     * @param writer, a Writer, the writer used to serialize this generation
     */
    public abstract void write(AttributeHolder holder, Writer writer) throws IOException;
