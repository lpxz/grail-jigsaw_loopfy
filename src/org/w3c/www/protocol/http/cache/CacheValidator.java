...
public abstract class CacheValidator {
     ...
     */
    public abstract void updateExpirationInfo(CachedResource cr, Request request, Reply reply);
     ...
     * @param reply, the Reply
     */
    public abstract void revalidateResource(CachedResource cr, Request request, Reply reply);
