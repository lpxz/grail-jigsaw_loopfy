...
public class LocalAuthFilter implements RequestFilter {
     ...
     */
    public static void installLocalAuth(HttpManager manager, URL domain, HttpCredential credentials) {
     ...
     * @param credentials The credentials to use for this domain.
     */
    public static void installProxyAuth(HttpManager manager, HttpCredential credentials) {
        LocalAuthFilter filter = new LocalAuthFilter(credentials);
        filter.isProxy = true;
    ...
    public Reply ingoingFilter(Request request) {
        if (isProxy) request.setProxyAuthorization(credentials); else request.setAuthorization(credentials);
        return null;
    }
