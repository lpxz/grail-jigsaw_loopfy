...
public class RuleNode {
    ...
    synchronized RuleNode addChild(String tok, Rule rule) {
        ...
        if (children == null) children = new Hashtable(5);
    ...
    public Rule lookupRule(String host) {
        ...
        int npart = 0;
        boolean isip = true;
        edu.hkust.clap.monitor.Monitor.loopBegin(304);
for (int i = 0; i < hostlen; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(304);
{
            if (host.charAt(i) == '.') {
                ...
                if (isip) isip = (host.charAt(i) >= '0') && (host.charAt(i) <= '9');
            }
        }} 
edu.hkust.clap.monitor.Monitor.loopEnd(304);
