...
public class HttpEntityMessage extends HttpMessage {
    ...
    static {
        registerHeader("Allow", "org.w3c.www.http.HttpTokenList", H_ALLOW);
        registerHeader("Content-Length", "org.w3c.www.http.HttpInteger", H_CONTENT_LENGTH);
        registerHeader("Content-Base", "org.w3c.www.http.HttpString", H_CONTENT_BASE);
        registerHeader("Content-Encoding", "org.w3c.www.http.HttpTokenList", H_CONTENT_ENCODING);
        registerHeader("Content-Language", "org.w3c.www.http.HttpTokenList", H_CONTENT_LANGUAGE);
        registerHeader("Content-Location", "org.w3c.www.http.HttpString", H_CONTENT_LOCATION);
        registerHeader("Content-Md5", "org.w3c.www.http.HttpString", H_CONTENT_MD5);
        registerHeader("Content-Range", "org.w3c.www.http.HttpContentRange", H_CONTENT_RANGE);
        registerHeader("Content-Type", "org.w3c.www.http.HttpMimeType", H_CONTENT_TYPE);
        registerHeader("Etag", "org.w3c.www.http.HttpEntityTag", H_ETAG);
        registerHeader("Expires", "org.w3c.www.http.HttpDate", H_EXPIRES);
        registerHeader("Last-Modified", "org.w3c.www.http.HttpDate", H_LAST_MODIFIED);
    }
    ...
    public void setAllow(String mth[]) {
        setHeaderValue(H_ALLOW, ((mth == null) ? null : new HttpTokenList(mth)));
    }
    ...
    public void setContentBase(String base) {
        setHeaderValue(H_CONTENT_BASE, ((base == null) ? null : new HttpString(true, base)));
    }
    ...
    public void setContentEncoding(String encodings[]) {
        setHeaderValue(H_CONTENT_ENCODING, ((encodings == null) ? null : new HttpTokenList(encodings)));
    }
    ...
    public void setContentLanguage(String languages[]) {
        setHeaderValue(H_CONTENT_LANGUAGE, ((languages == null) ? null : new HttpTokenList(languages)));
    }
    ...
    public void setContentLength(int length) {
        if (length < 0) setHeaderValue(H_CONTENT_LENGTH, null); else setHeaderValue(H_CONTENT_LENGTH, new HttpInteger(true, length));
    }
    ...
    public void setContentLocation(String location) {
        setHeaderValue(H_CONTENT_LOCATION, ((location == null) ? null : new HttpString(true, location)));
    }
    ...
    public void setContentMD5(String md5) {
        setHeaderValue(H_CONTENT_MD5, ((md5 == null) ? null : new HttpString(true, md5)));
    }
    ...
    public void setContentType(MimeType type) {
        setHeaderValue(H_CONTENT_TYPE, (type == null) ? null : new HttpMimeType(true, type));
    }
    ...
    public void setExpires(long date) {
        setHeaderValue(H_EXPIRES, ((date == -1) ? null : new HttpDate(true, date)));
    }
    ...
    public void setLastModified(long date) {
        setHeaderValue(H_LAST_MODIFIED, ((date == -1) ? null : new HttpDate(true, date)));
    }
