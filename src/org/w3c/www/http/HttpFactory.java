...
public class HttpFactory {
    ...
    public static HttpAcceptList makeAcceptList(HttpAccept accepts[]) {
        if (accepts == null) return new HttpAcceptList(null); else return new HttpAcceptList(accepts);
    }
     ...
     */
    public static HttpAcceptCharset makeAcceptCharset(String charset, double quality) {
     ...
     */
    public static HttpAcceptEncoding makeAcceptEncoding(String enc, double quality) {
     ...
     */
    public static HttpAcceptEncodingList parseAcceptEncodingList(String strval) {
     ...
     */
    public static HttpAcceptLanguage makeAcceptLanguage(String lang, double quality) {
     ...
     */
    public static HttpContentRange makeContentRange(String unit, int firstpos, int lastpos, int length) {
     ...
     * @see HttpWarning
     */
    public static HttpWarning makeWarning(int status, String agent, String text) {
