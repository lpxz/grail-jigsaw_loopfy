...
public class HttpReplyMessage extends HttpEntityMessage {
    ...
    static {
        registerHeader("Accept-Ranges", "org.w3c.www.http.HttpTokenList", H_ACCEPT_RANGES);
        registerHeader("Age", "org.w3c.www.http.HttpInteger", H_AGE);
        registerHeader("Location", "org.w3c.www.http.HttpString", H_LOCATION);
        registerHeader("Proxy-Authenticate", "org.w3c.www.http.HttpChallenge", H_PROXY_AUTHENTICATE);
        registerHeader("Public", "org.w3c.www.http.HttpTokenList", H_PUBLIC);
        registerHeader("Retry-After", "org.w3c.www.http.HttpString", H_RETRY_AFTER);
        registerHeader("Server", "org.w3c.www.http.HttpString", H_SERVER);
        registerHeader("Trailer", "org.w3c.www.http.HttpTokenList", H_TRAILER);
        registerHeader("Vary", "org.w3c.www.http.HttpCaseTokenList", H_VARY);
        registerHeader("Warning", "org.w3c.www.http.HttpWarningList", H_WARNING);
        registerHeader("WWW-Authenticate", "org.w3c.www.http.HttpChallenge", H_WWW_AUTHENTICATE);
        registerHeader("Authentication-Info", "org.w3c.www.http.HttpParamList", H_AUTHENTICATION_INFO);
    }
    ...
    public boolean notifyBeginParsing(MimeParser parser) throws HttpParserException, IOException {
        ...
        int ch = parser.read();
        int len = 0;
        edu.hkust.clap.monitor.Monitor.loopBegin(1119);
while ((ch == '\r') || (ch == '\n')) { 
edu.hkust.clap.monitor.Monitor.loopInc(1119);
ch = parser.read();} 
edu.hkust.clap.monitor.Monitor.loopEnd(1119);
...
while (true) { 
{
            ...
            if (len > 16 * 1024) throw new HttpParserException("Invalid HTTP");
            ch = parser.read();
        }} 
    ...
    public String getStandardReason(int status) {
        ...
        switch(category) {
            case 1:
                if ((catcode >= 0) && (catcode < msg_100.length)) return HTTP.msg_100[catcode];
                break;
            case 2:
                if ((catcode >= 0) && (catcode < msg_200.length)) return HTTP.msg_200[catcode];
                break;
            case 3:
                if ((catcode >= 0) && (catcode < msg_300.length)) return HTTP.msg_300[catcode];
                break;
            case 4:
                if ((catcode >= 0) && (catcode < msg_400.length)) return HTTP.msg_400[catcode];
                break;
            case 5:
                if ((catcode >= 0) && (catcode < msg_500.length)) return HTTP.msg_500[catcode];
                break;
        }
        return null;
    }
    ...
    public void setStatus(int status) {
        if ((status != this.status) || (reason == null)) this.reason = getStandardReason(status);
        this.status = status;
    }
    ...
    public void setPublic(boolean onoff) {
        HttpCacheControl cc = getCacheControl();
        if (onoff && (cc == null)) setCacheControl(cc = new HttpCacheControl(true)); else return;
        cc.setPublic(onoff);
    }
    ...
    public void setAcceptRanges(String units[]) {
        setHeaderValue(H_ACCEPT_RANGES, ((units == null) ? null : new HttpTokenList(units)));
    }
    ...
    public void setAge(int age) {
        setHeaderValue(H_AGE, ((age == -1) ? null : new HttpInteger(true, age)));
    }
    ...
    public void setLocation(URL location) {
        setHeaderValue(H_LOCATION, ((location == null) ? null : new HttpString(true, location.toExternalForm())));
    }
    ...
    public void setLocation(String location) {
        setHeaderValue(H_LOCATION, ((location == null) ? null : new HttpString(true, location)));
    }
    ...
    public void setPublic(String mth[]) {
        setHeaderValue(H_PUBLIC, ((mth == null) ? null : new HttpTokenList(mth)));
    }
    ...
    public void setServer(String server) {
        setHeaderValue(H_SERVER, ((server == null) ? null : new HttpString(true, server)));
    }
    ...
    public void setRetryAfter(int delay) {
        setHeaderValue(H_RETRY_AFTER, ((delay == -1) ? null : new HttpString(true, ((new Integer(delay)).toString()))));
    }
    ...
    public void setRetryAfter(long date) {
        if (date == -1) {
            ...
            setHeaderValue(H_RETRY_AFTER, new HttpString(true, d.toExternalForm()));
        }
    }
    ...
    public void setVary(String varies[]) {
        setHeaderValue(H_VARY, ((varies == null) ? null : new HttpCaseTokenList(varies)));
    }
    ...
    public void setWarning(HttpWarning warnings[]) {
        setHeaderValue(H_WARNING, ((warnings == null) ? null : new HttpWarningList(warnings)));
    }
