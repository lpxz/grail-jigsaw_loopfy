...
public class HttpRequestMessage extends HttpEntityMessage {
    ...
    static {
        registerHeader("Accept", "org.w3c.www.http.HttpAcceptList", H_ACCEPT);
        registerHeader("Accept-Charset", "org.w3c.www.http.HttpAcceptCharsetList", H_ACCEPT_CHARSET);
        registerHeader("Accept-Encoding", "org.w3c.www.http.HttpAcceptEncodingList", H_ACCEPT_ENCODING);
        registerHeader("Accept-Language", "org.w3c.www.http.HttpAcceptLanguageList", H_ACCEPT_LANGUAGE);
        registerHeader("Authorization", "org.w3c.www.http.HttpCredential", H_AUTHORIZATION);
        registerHeader("From", "org.w3c.www.http.HttpString", H_FROM);
        registerHeader("Host", "org.w3c.www.http.HttpString", H_HOST);
        registerHeader("If-Modified-Since", "org.w3c.www.http.HttpDate", H_IF_MODIFIED_SINCE);
        registerHeader("If-Match", "org.w3c.www.http.HttpEntityTagList", H_IF_MATCH);
        registerHeader("If-None-Match", "org.w3c.www.http.HttpEntityTagList", H_IF_NONE_MATCH);
        registerHeader("If-Range", "org.w3c.www.http.HttpEntityTag", H_IF_RANGE);
        registerHeader("If-Unmodified-Since", "org.w3c.www.http.HttpDate", H_IF_UNMODIFIED_SINCE);
        registerHeader("Max-Forwards", "org.w3c.www.http.HttpInteger", H_MAX_FORWARDS);
        registerHeader("Proxy-Authorization", "org.w3c.www.http.HttpCredential", H_PROXY_AUTHORIZATION);
        registerHeader("Range", "org.w3c.www.http.HttpRangeList", H_RANGE);
        registerHeader("Referer", "org.w3c.www.http.HttpString", H_REFERER);
        registerHeader("User-Agent", "org.w3c.www.http.HttpString", H_USER_AGENT);
        registerHeader("Expect", "org.w3c.www.http.HttpString", H_EXPECT);
        registerHeader("TE", "org.w3c.www.http.HttpAcceptEncodingList", H_TE);
    }
    ...
    protected void startEmit(OutputStream out, int what) throws IOException {
        if ((what & EMIT_HEADERS) != EMIT_HEADERS) return;
        if ((major >= 1) && !hasHeader(H_HOST)) {
            String h = ((((url.getPort() == 80) && url.getProtocol().equalsIgnoreCase("http")) || ((url.getPort() == 443) && url.getProtocol().equalsIgnoreCase("https")) || (url.getPort() == -1)) ? url.getHost() : url.getHost() + ":" + url.getPort());
    ...
    public boolean notifyBeginParsing(MimeParser parser) throws HttpParserException, IOException {
        HttpBuffer buf = new HttpBuffer();
        int ch = parser.read();
        edu.hkust.clap.monitor.Monitor.loopBegin(641);
while ((ch == '\r') || (ch == '\n')) { 
edu.hkust.clap.monitor.Monitor.loopInc(641);
{
            ch = parser.read();
        }} 
edu.hkust.clap.monitor.Monitor.loopEnd(641);

edu.hkust.clap.monitor.Monitor.loopBegin(642);
        loop: 
while (true) { 
edu.hkust.clap.monitor.Monitor.loopInc(642);
{
            switch(ch) {
                case -1:
...
edu.hkust.clap.monitor.Monitor.loopEnd(642);
    ...
    public void setAccept(HttpAccept accepts[]) {
        setHeaderValue(H_ACCEPT, ((accepts == null) ? null : new HttpAcceptList(accepts)));
    }
    ...
    public void setAcceptCharset(HttpAcceptCharset charsets[]) {
        setHeaderValue(H_ACCEPT_CHARSET, ((charsets == null) ? null : new HttpAcceptCharsetList(charsets)));
    }
    ...
    public void setAcceptEncoding(HttpAcceptEncoding encoding[]) {
        setHeaderValue(H_ACCEPT_ENCODING, ((encoding == null) ? null : new HttpAcceptEncodingList(encoding)));
    }
    ...
    public HttpAcceptLanguage[] getAcceptLanguage() {
        ...
        return ((value != null) ? (HttpAcceptLanguage[]) value.getValue() : null);
    }
    ...
    public void setAcceptLanguage(HttpAcceptCharset langs[]) {
        setHeaderValue(H_ACCEPT_LANGUAGE, ((langs == null) ? null : new HttpAcceptCharsetList(langs)));
    }
    ...
    public void setFrom(String from) {
        setHeaderValue(H_FROM, ((from == null) ? null : new HttpString(true, from)));
    }
    ...
    public void setHost(String host) {
        setHeaderValue(H_HOST, ((host == null) ? null : new HttpString(true, host)));
    }
    ...
    public void setIfModifiedSince(long ims) {
        setHeaderValue(H_IF_MODIFIED_SINCE, ((ims == -1) ? null : new HttpDate(true, ims)));
    }
    ...
    public void setIfMatch(HttpEntityTag etags[]) {
        setHeaderValue(H_IF_MATCH, ((etags != null) ? new HttpEntityTagList(etags) : null));
    }
    ...
    public void setIfNoneMatch(HttpEntityTag etags[]) {
        setHeaderValue(H_IF_NONE_MATCH, ((etags == null) ? null : new HttpEntityTagList(etags)));
    }
    ...
    public void setRange(HttpRange ranges[]) {
        setHeaderValue(H_RANGE, ((ranges == null) ? null : new HttpRangeList(ranges)));
    }
    ...
    public void setReferer(String referer) {
        setHeaderValue(H_REFERER, ((referer == null) ? null : new HttpString(true, referer)));
    }
    ...
    public void setUserAgent(String ua) {
        setHeaderValue(H_USER_AGENT, ((ua == null) ? null : new HttpString(true, ua)));
    }
    ...
    public void setExpect(String expect) {
        setHeaderValue(H_EXPECT, ((expect == null) ? null : new HttpString(true, expect)));
    }
    ...
    public void setTE(HttpAcceptEncoding encoding[]) {
        setHeaderValue(H_TE, ((encoding == null) ? null : new HttpAcceptEncodingList(encoding)));
    }
