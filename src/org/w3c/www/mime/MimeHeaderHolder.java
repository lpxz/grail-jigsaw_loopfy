...
public interface MimeHeaderHolder {
     ...
     */
    public boolean notifyBeginParsing(MimeParser parser) throws MimeParserException, IOException;
     ...
     * @exception IOException if an IO error occurs.
     */
    public void notifyEndParsing(MimeParser parser) throws MimeParserException, IOException;
}
