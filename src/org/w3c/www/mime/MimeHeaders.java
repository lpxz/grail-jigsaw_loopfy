...
public class MimeHeaders implements MimeHeaderHolder {
    ...
    public void notifyHeader(String name, byte buf[], int off, int len) throws MimeParserException {
        ...
        String newval = ((oldval != null) ? oldval + "," + new String(buf, 0, off, len) : new String(buf, 0, off, len));
    ...
    public void setValue(String name, String value) {
        if (headers == null) headers = new Hashtable(5);
    ...
    public void dump(PrintStream out) {
        ...
        if (names != null) {
            edu.hkust.clap.monitor.Monitor.loopBegin(479);
while (names.hasMoreElements()) { 
edu.hkust.clap.monitor.Monitor.loopInc(479);
{
                String name = (String) names.nextElement();
                out.println(name + ": " + headers.get(name));
            }} 
edu.hkust.clap.monitor.Monitor.loopEnd(479);
