...
public class DAVFactory {
    ...
    public static DAVPropStat createPropStat(String status, Document document) {
    ...
    public static DAVPropStat createPropStat(String status, String propname, Document document) {
        Element el = createDAVElement(document, DAVNode.PROPSTAT_NODE);
        DAVPropStat dps = new DAVPropStat(el);
        dps.setStatus(status);
    ...
    public static DAVPropStat createPropStatNS(String status, Node node, Document document) {
        Element el = createDAVElement(document, DAVNode.PROPSTAT_NODE);
        DAVPropStat dps = new DAVPropStat(el);
        dps.setStatus(status);
        DAVProperties dp = createProperties(document);
    ...
    public static DAVPropStat createPropStat(String status, DAVProperties props, Document document) {
        Element el = createDAVElement(document, DAVNode.PROPSTAT_NODE);
        DAVPropStat dps = new DAVPropStat(el);
        dps.setStatus(status);
    ...
    public static DAVResponse createResponse(String url, String status, Document document) {
        Element el = createDAVElement(document, DAVNode.RESPONSE_NODE);
        DAVResponse dr = new DAVResponse(el);
        dr.addDAVNode(DAVNode.HREF_NODE, url);
    ...
    public static DAVResponse createResponse(String url, String status, String description, Document document) {
        Element el = createDAVElement(document, DAVNode.RESPONSE_NODE);
        DAVResponse dr = new DAVResponse(el);
        dr.addDAVNode(DAVNode.HREF_NODE, url);
        dr.addDAVNode(DAVNode.STATUS_NODE, status);
    ...
    public static DAVResponse createPropStatResponse(String url, String status, DAVProperties props, Document document) {
    ...
    public static DAVPropAction createPropAction(int type, DAVProperties props, Document document) {
        Element el = null;
    ...
    public static DAVPropertyUpdate createPropertyUpdate(DAVPropAction act[], Document document) {
    ...
    public static DAVPropertyUpdate createPropertyUpdate(Element el, DAVPropAction act) {
        DAVPropertyUpdate dpu = new DAVPropertyUpdate(el);
        DAVPropAction array[] = { act };
        dpu.setActions(array);
        return dpu;
