...
public class DAVBody implements ErrorHandler {
    ...
    public static synchronized Document getDocument(InputStream in, ErrorHandler handler) throws IOException, SAXException {
    ...
    public static Document createDocument(String root) {
        Document newdoc = domimpl.createDocument(WEBDAV.NAMESPACE_URI, WEBDAV.NAMESPACE_PREFIX + ":" + root, null);
        Element rootel = newdoc.getDocumentElement();
        try {
            rootel.setAttribute("xmlns:" + WEBDAV.NAMESPACE_PREFIX, WEBDAV.NAMESPACE_URI);
    ...
    public static Document createDocumentNS(String root, String ns, String prefix) {
     ...
     * Constructor
     */
    public DAVBody(InputStream in) throws IOException, SAXException {
