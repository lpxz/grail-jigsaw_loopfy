    ...
    class SelectPopup extends ClosableFrame implements ItemListener {
        ...
        public void itemStateChanged(ItemEvent e) {
            if (e.getStateChange() == ItemEvent.SELECTED) {
                String selected = (String) list.getItem(((Integer) e.getItem()).intValue());
                if (modifier != null) selected = modifier.modify(selected);
        ...
        protected void setDefaultItems() {
            ...
            if (items != null) {
                edu.hkust.clap.monitor.Monitor.loopBegin(580);
for (int i = 0; i < items.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(580);
if (items[i] != null) list.addItem(items[i]);} 
edu.hkust.clap.monitor.Monitor.loopEnd(580);
        ...
        SelectPopup(SelectComponent parent, EditorFeeder feeder, EditorModifier modifier) {
            super("Select");
            this.parent = parent;
            this.feeder = feeder;
    ...
    class SelectComponent extends Panel implements ActionListener, TextListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (command != null) {
                if (command.equals("edit")) {
                    if (popup == null) popup = new SelectPopup(this, feeder, modifier);
                    popup.show();
                }
            }
        }
        ...
        SelectComponent(SelectEditor editor, EditorFeeder feeder, EditorModifier modifier, String selected) {
            super();
            this.feeder = feeder;
            this.modifier = modifier;
            this.editor = editor;
    ...
    protected void createComponent(EditorFeeder feeder, EditorModifier modifier, String selected) {
        if (comp == null) comp = new SelectComponent(this, feeder, modifier, selected);
    }
    ...
    public void initialize(RemoteResourceWrapper w, Attribute a, Object o, Properties p) throws RemoteAccessException {
        ...
        if (feederClass == null) throw new RuntimeException("SelectEditor mis-configuration: " + FEEDER_CLASS_P + " property undefined.");
        try {
            ...
            ex.printStackTrace();
            throw new RuntimeException("SelectEditor mis-configured: " + " unable to instantiate " + feederClass + ".");
        }
        ...
        if (modifierClass != null) {
            try {
                ...
                ex.printStackTrace();
                throw new RuntimeException("SelectEditor mis-configured: " + " unable to instantiate " + modifierClass + ".");
            }
        }
        String selected = (String) o;
        createComponent(feeder, modifier, selected);
        if (selected != null) oldvalue = new String(selected);
    }
}
