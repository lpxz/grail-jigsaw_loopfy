...
public class DateAttributeEditor extends AttributeEditor {
    ...
    class DateActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getActionCommand().equals("+")) updateValue(field, true); else updateValue(field, false);
        }
    ...
    public DateAttributeEditor() {
        ...
        Image up = Toolkit.getDefaultToolkit().getImage(pm.getIconLocation("pup"));
        Image down = Toolkit.getDefaultToolkit().getImage(pm.getIconLocation("pdown"));
    ...
    public void initialize(RemoteResourceWrapper w, Attribute a, Object o, Properties p) throws RemoteAccessException {
        ...
        if (o == null) {
            ...
            try {
                ...
                if (d == null) if (a.getDefault() != null) d = new Date(((Long) a.getDefault()).longValue());
            } catch (Exception ex) {
            }
            if (d != null) {
                origd = d;
