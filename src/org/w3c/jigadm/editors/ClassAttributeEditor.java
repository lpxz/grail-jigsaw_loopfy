...
public class ClassAttributeEditor extends AttributeEditor {
    ...
    protected void setClassAttribute(Class c) {
        if (c != null) widget.setText(c.getName()); else widget.setText("");
    }

    protected Class getClassAttribute() {
        String classname = widget.getText();
        if (classname != null) if (classname.length() > 0) {
            try {
                Class c = Class.forName(classname);
                return c;
            } catch (ClassNotFoundException ex) {
                (new MessagePopup("Error", "Class not found : " + classname)).show();
                return null;
            }
        }
        return null;
    ...
    public void initialize(RemoteResourceWrapper w, Attribute a, Object o, Properties p) throws RemoteAccessException {
        ...
        if (o == null) {
            ...
            if (v == null) if (a.getDefault() != null) v = (Class) a.getDefault();
            if (v != null) {
                origs = v;
                setClassAttribute(origs);
            }
