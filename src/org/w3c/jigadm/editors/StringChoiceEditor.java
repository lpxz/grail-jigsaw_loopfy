...
public class StringChoiceEditor extends AttributeEditor {
    ...
    class StringChoiceComponent extends StringChoice implements TextListener {
        ...
        StringChoiceComponent(StringChoiceEditor editor, String selected, EditorFeeder feeder) {
            super();
    ...
    protected void createComponent(EditorFeeder feeder, String selected) {
        if (comp == null) comp = new StringChoiceComponent(this, selected, feeder);
    }
