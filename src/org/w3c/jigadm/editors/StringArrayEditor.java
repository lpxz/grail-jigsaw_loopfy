        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            if (command.equals("add")) {
                ...
                if ((isels != null) && (isels.length > 0)) {
                    modified = true;
                    edu.hkust.clap.monitor.Monitor.loopBegin(686);
for (int i = 0; i < isels.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(686);
{
                        String item = witems.getItem(isels[i]);
                        wselected.addItem(item);
                        witems.deselect(isels[i]);
                    }} 
edu.hkust.clap.monitor.Monitor.loopEnd(686);

                    edu.hkust.clap.monitor.Monitor.loopBegin(687);
for (int i = 0; i < isels.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(687);
witems.delItem(isels[i] - i);} 
edu.hkust.clap.monitor.Monitor.loopEnd(687);
                ...
                if ((isels != null) && (isels.length > 0)) {
                    modified = true;
                    edu.hkust.clap.monitor.Monitor.loopBegin(688);
for (int i = 0; i < isels.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(688);
{
                        String item = wselected.getItem(isels[i]);
                        witems.addItem(item);
                        wselected.deselect(isels[i]);
                    }} 
edu.hkust.clap.monitor.Monitor.loopEnd(688);

                    edu.hkust.clap.monitor.Monitor.loopBegin(689);
for (int i = 0; i < isels.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(689);
wselected.delItem(isels[i] - i);} 
edu.hkust.clap.monitor.Monitor.loopEnd(689);
	 ...
	 */
        protected void createDefaultItems(EditorFeeder feeder) {
            ...
            if (items != null) {
                edu.hkust.clap.monitor.Monitor.loopBegin(690);
for (int i = 0; i < items.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(690);
if (items[i] != null) witems.addItem(items[i]);} 
edu.hkust.clap.monitor.Monitor.loopEnd(690);
...
edu.hkust.clap.monitor.Monitor.loopEnd(690);
        ...
        protected void setSelectedItems(String selected[]) {
            wselected.removeAll();
            if (selected != null) {
                edu.hkust.clap.monitor.Monitor.loopBegin(691);
for (int i = 0; i < selected.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(691);
if (selected[i] != null) wselected.addItem(selected[i]);} 
edu.hkust.clap.monitor.Monitor.loopEnd(691);
        ...
        public EditStringArrayPopup(StringArrayComponent parent, EditorFeeder feeder, String selected[], String title) {
            ...
            Image left = Toolkit.getDefaultToolkit().getImage(pm.getIconLocation("shadowleft"));
            Image right = Toolkit.getDefaultToolkit().getImage(pm.getIconLocation("shadowright"));
    ...
    class StringArrayComponent extends ListEditor {
        ...
        protected void edit() {
            if (popup == null) popup = new EditStringArrayPopup(this, feeder, getSelectedItems(), "Edit"); else popup.start(getSelectedItems());
            popup.show();
            popup.toFront();
        }
        ...
        protected void setSelectedItems(String selected[]) {
            list.removeAll();
            if (selected != null) {
                edu.hkust.clap.monitor.Monitor.loopBegin(692);
for (int i = 0; i < selected.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(692);
if (selected[i] != null) list.addItem(selected[i]);} 
edu.hkust.clap.monitor.Monitor.loopEnd(692);
