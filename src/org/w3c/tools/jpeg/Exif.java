...
public class Exif {
    ...
    protected void processExifDir(int dirStart, int offsetBase) {
        ...
        edu.hkust.clap.monitor.Monitor.loopBegin(289);
for (int de = 0; de < numEntries; de++) { 
edu.hkust.clap.monitor.Monitor.loopInc(289);
{
            ...
            if (tag == TAG_EXIF_OFFSET || tag == TAG_INTEROP_OFFSET) {
                ...
                if (decoder.containsKey(tagName)) {
                    ...
                    if (decoder != null) {
                        decoder.decode(exif, data, format, valueOffset, byteCount);
                    }
                } else {
                    switch(format) {
...
edu.hkust.clap.monitor.Monitor.loopEnd(289);
