...
public class SQL {
    ...
    public static String encode(String string) {
        ...
        char c;
        buffer.append("'");
        edu.hkust.clap.monitor.Monitor.loopBegin(1157);
for (int i = 0; i < len; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(1157);
{
...
edu.hkust.clap.monitor.Monitor.loopEnd(1157);
    ...
    public static Object getMatchingValue(Class c, Object value) {
        ...
        if (c == String.class) {
            ...
            return new Boolean((stringvalue.equalsIgnoreCase("true") || stringvalue.equalsIgnoreCase("t") || stringvalue.equalsIgnoreCase("y") || stringvalue.equalsIgnoreCase("yes") || stringvalue.equalsIgnoreCase("1")));
