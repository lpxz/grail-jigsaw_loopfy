...
public class ConnectionManager implements PropertyMonitoring {
    ...
    public static final long WAIT_TIMEOUT = 1000 * 60 * 2;
...
edu.hkust.clap.monitor.Monitor.loopEnd(51);
    ...
    protected Comparator conn_comparator = new Comparator() {
        ...
        public int compare(Object o1, Object o2) {
            if ((o1 instanceof JdbcConnection) && (o2 instanceof JdbcConnection)) {
                ...
                return (int) (conn2.getQueryStamp() - conn1.getQueryStamp());
            }
...
{
            JdbcConnection conn = (JdbcConnection) usedConnections.removeFirst();
            conn.delete();
        }} 
edu.hkust.clap.monitor.Monitor.loopEnd(52);
     ...
     */
    protected synchronized void waitForConnection(JdbcServer server) throws InterruptedException {
