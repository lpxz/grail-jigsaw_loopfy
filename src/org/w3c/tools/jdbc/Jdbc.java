...
public class Jdbc {
    ...
    public static Properties setDriver(Properties props, String driver) {
        if (driver != null) props.put(JDBC_DRIVER_P, driver);
        return props;
    }
    ...
    public static Properties setUser(Properties props, String user) {
        if (user != null) props.put(USER_P, user);
        return props;
    }
    ...
    public static Properties setPassword(Properties props, String password) {
        if (password != null) props.put(PASSWORD_P, password);
        return props;
    }

    private static void setBoolean(Properties props, String name, boolean bool) {
