...
public class XMLReader extends HandlerBase implements JigXML {
    ...
    public void endElement(String name) throws SAXException {
        ...
        if (iname == iRESOURCE_TAG) {
            ...
            if (value != null) defs.put(currentA.getName(), value);
            currentA = null;
        } else if (iname == iRESARRAY_TAG) {
            Hashtable defs = (Hashtable) defsStack.peek();
    ...
    public Resource[] readResources() throws IOException, SerializationException {
        ...
        edu.hkust.clap.monitor.Monitor.loopBegin(1037);
for (int i = 0; i < len; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(1037);
crs[i] = (Resource) holders[i];} 
edu.hkust.clap.monitor.Monitor.loopEnd(1037);
