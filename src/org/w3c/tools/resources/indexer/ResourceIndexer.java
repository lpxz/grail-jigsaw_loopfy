...
public interface ResourceIndexer {
     ...
     *    database.
     */
    public abstract Resource createResource(ContainerResource container, RequestInterface request, File directory, String name, Hashtable defs);
     ...
     */
    public abstract String getIndexedName(File directory, String name);
}
