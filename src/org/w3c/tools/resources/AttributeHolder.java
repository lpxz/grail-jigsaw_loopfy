...
edu.hkust.clap.monitor.Monitor.loopEnd(45);
    ...
    public void setString(int idx, String s) throws IllegalAttributeAccess {
     ...
     */
    public synchronized Object getValue(int idx, Object def) throws IllegalAttributeAccess {
        if ((idx < 0) || (idx >= attributes.length)) throw new IllegalAttributeAccess(this, idx);
        Object value = values[idx];
        if (value == null) return (def == null) ? attributes[idx].getDefault() : def; else return value;
    }
     ...
     *    of the resource's attributes.
     */
    public Object unsafeGetValue(int idx, Object def) throws IllegalAttributeAccess {
        if ((idx < 0) || (idx >= attributes.length)) throw new IllegalAttributeAccess(this, idx);
        Object value = values[idx];
        if (value == null) return (def == null) ? attributes[idx].getDefault() : def; else return value;
    }
     ...
     */
    public Object getValue(String name, Object def) throws IllegalAttributeAccess {
    ...
    public boolean getBoolean(int idx, boolean def) {
        ...
        if (value == null) {
            ...
            throw new IllegalAttributeAccess(this, attributes[idx], "getBoolean");
        }
    }
    ...
    public char getChar(int idx, char def) {
        ...
        if (value == null) {
            ...
            throw new IllegalAttributeAccess(this, attributes[idx], "getChar");
        }
    }
    ...
    public double getDouble(int idx, double def) {
        ...
        if (value == null) {
            ...
            throw new IllegalAttributeAccess(this, attributes[idx], "getDouble");
        }
    }
    ...
    public float getFloat(int idx, float def) {
        ...
        if (value == null) {
            ...
            throw new IllegalAttributeAccess(this, attributes[idx], "getFloat");
        }
    }
    ...
    public int getInt(int idx, int def) {
        ...
        if (value == null) {
            ...
            throw new IllegalAttributeAccess(this, attributes[idx], "getInt");
        }
    }
    ...
    public long getLong(int idx, long def) {
        ...
        if (value == null) {
            ...
            throw new IllegalAttributeAccess(this, attributes[idx], "getLong");
        }
    }
    ...
    public String getString(int idx, String def) {
        ...
        if (value == null) {
            ...
            throw new IllegalAttributeAccess(this, attributes[idx], "getString");
        }
    }
...
{
            if (values[i] != null) System.out.println(attributes[i].getName() + "=" + values[i]);
        }} 
edu.hkust.clap.monitor.Monitor.loopEnd(49);
    ...
    public AttributeHolder() {
        ...
        if ((attributes != null) && (attributes.length > 0)) this.values = new Object[attributes.length];
    }
}
