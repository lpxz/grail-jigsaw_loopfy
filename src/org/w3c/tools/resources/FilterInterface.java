...
public interface FilterInterface {
   ...
   */
    public ReplyInterface ingoingFilter(RequestInterface request, FilterInterface filters[], int fidx) throws ProtocolException;
   ...
   * @param fidx The index in the above array of the filter being called.
   */
    public ReplyInterface exceptionFilter(RequestInterface request, ProtocolException ex, FilterInterface filters[], int fidx);
