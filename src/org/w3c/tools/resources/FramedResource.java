...
public class FramedResource extends Resource implements FrameEventListener {
    ...
    static {
        ...
        a = new IntegerAttribute("oid", null, Attribute.COMPUTED);
     ...
     */
    protected void registerFrameIfNone(String classname, String identifier) throws ClassNotFoundException, IllegalAccessException, InstantiationException, ClassCastException {
...
edu.hkust.clap.monitor.Monitor.loopInc(7);
{
            ...
            if (rr == null) {
                rr = (ResourceReference) new FrameReference(frames[i], getResourceReference());
...
edu.hkust.clap.monitor.Monitor.loopEnd(7);
    ...
    public synchronized ResourceReference getFrameReference(Class c) {
        ...
        if (rr == null) {
            rr = (ResourceReference) new FrameReference(frame, getResourceReference());
...
edu.hkust.clap.monitor.Monitor.loopInc(8);
{
                ...
                if (fr.getIdentifier().equals(identifier)) return fr;
            }} 
...
edu.hkust.clap.monitor.Monitor.loopEnd(8);
    ...
    public void postEvent(ResourceEvent evt) {
        ...
        if (space != null) space.getEventQueue().sendEvent(evt);
    }
    ...
    protected void postAttributeChangeEvent(int idx, Object newvalue) {
        ...
        if ((attrListener != null) && (getResourceReference() != null)) {
            AttributeChangedEvent evt = new AttributeChangedEvent(getResourceReference(), attributes[idx], newvalue);
    ...
    protected void fireAttributeChangeEvent(AttributeChangedEvent evt) {
        if (attrListener != null) attrListener.attributeChanged(evt);
    }
    ...
    protected void postStructureChangedEvent(ResourceReference rr, int type) {
        if ((structListener != null) && (rr != null)) {
            StructureChangedEvent evt = new StructureChangedEvent(rr, type);
            postEvent(evt);
        }
    }
    ...
    protected void postStructureChangedEvent(int type) {
        if ((structListener != null) && (getResourceReference() != null)) {
            StructureChangedEvent evt = new StructureChangedEvent(getResourceReference(), type);
            postEvent(evt);
        }
    }
    ...
    protected void fireStructureChangedEvent(int type) {
        if (structListener != null) {
            ...
            if (resref != null) {
                StructureChangedEvent evt = new StructureChangedEvent(resref, type);
