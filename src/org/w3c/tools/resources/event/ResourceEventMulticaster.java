...
public class ResourceEventMulticaster implements StructureChangedListener, FrameEventListener, AttributeChangedListener {
     ...
     */
    public static AttributeChangedListener add(AttributeChangedListener a, AttributeChangedListener b) {
     ...
     */
    public static AttributeChangedListener remove(AttributeChangedListener l, AttributeChangedListener ol) {
     ...
     */
    public static FrameEventListener add(FrameEventListener a, FrameEventListener b) {
     ...
     */
    public static FrameEventListener remove(FrameEventListener l, FrameEventListener oldl) {
     ...
     */
    public static StructureChangedListener add(StructureChangedListener a, StructureChangedListener b) {
     ...
     */
    public static StructureChangedListener remove(StructureChangedListener l, StructureChangedListener ol) {
