...
public class ResourceStateFilter extends ResourceFilter {
    ...
    protected void showState() {
        ...
        if (resource == null) System.out.println("NULL resource"); else {
            ...
            System.out.println("Reference  : " + resource.getResourceReference());
        }
        System.out.println("-----------------------------------------");
    }
    ...
    public void registerResource(FramedResource resource) {
        ...
        if (fr != null) fr.addAttributeChangedListener(this);
    }
}
