...
public class IllegalAttributeAccess extends RuntimeException {
     ...
     */
    public IllegalAttributeAccess(AttributeHolder holder, Attribute attr, Object value) {
        super("Illegal attribute value " + ((value == null) ? "null" : value.toString()) + " for " + attr.getName());
        this.holder = holder;
        this.attribute = attr;
        this.value = value;
    }
     ...
     */
    public IllegalAttributeAccess(AttributeHolder holder, Attribute attr, String accessor) {
