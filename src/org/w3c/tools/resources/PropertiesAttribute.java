...
public class PropertiesAttribute extends ArrayAttribute {
    ...
    public Object unpickle(String array[]) {
        ...
        edu.hkust.clap.monitor.Monitor.loopBegin(1112);
for (int i = 0; i < array.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(1112);
{
...
edu.hkust.clap.monitor.Monitor.loopEnd(1112);
    ...
    public String[] pickle(Object o) {
        ...
        edu.hkust.clap.monitor.Monitor.loopBegin(1113);
for (int i = 0; i < len; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(1113);
{
            String key = (String) e.nextElement();
            array[i] = key + "=" + (String) a.get(key);
        }} 
edu.hkust.clap.monitor.Monitor.loopEnd(1113);
