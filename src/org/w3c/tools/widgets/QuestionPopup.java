...
public class QuestionPopup extends Dialog implements ActionListener {
    ...
    public void actionPerformed(ActionEvent evt) {
        if (answerListener != null) {
            ...
            if (command.equals("yes")) answerListener.questionAnswered(this, answerListener.YES); else if (command.equals("no")) answerListener.questionAnswered(this, answerListener.NO);
        }
    }

    public QuestionPopup(Frame parent, String question) {
        this(parent, defaultTitle, question, defaultYesMsg, defaultNoMsg, true);
    }

    public QuestionPopup(Frame parent, String question, boolean modal) {
        this(parent, defaultTitle, question, defaultYesMsg, defaultNoMsg, modal);
    }

    public QuestionPopup(Frame parent, String title, String question, boolean modal) {
        this(parent, title, question, defaultYesMsg, defaultNoMsg, modal);
    }

    public QuestionPopup(Frame parent, String title, String question, String yes, String no, boolean modal) {
