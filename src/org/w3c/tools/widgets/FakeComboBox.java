...
public class FakeComboBox extends Panel implements ActionListener, ItemListener {
    ...
    class GoodList extends List {
        ...
        public Dimension getMinimumSize() {
            return new Dimension(max(parent.text.getSize().width, super.getMinimumSize().width), super.getMinimumSize().height);
        }
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (command.equals("popup")) {
            if (plist.isShowing()) hidePopup(); else showPopup();
    ...
    public FakeComboBox(int size, int listSize, boolean editable, String imagePath1, String imagePath2) {
        super();
