...
public class IPTextField extends Panel implements TextEditable {
    ...
    class IntegerListener extends KeyAdapter {
        ...
        public void keyPressed(KeyEvent ke) {
            if (ke.getKeyCode() == KeyEvent.VK_DELETE || ke.getKeyCode() == KeyEvent.VK_BACK_SPACE || ke.getKeyCode() == KeyEvent.VK_UP || ke.getKeyCode() == KeyEvent.VK_DOWN || ke.getKeyCode() == KeyEvent.VK_LEFT || ke.getKeyCode() == KeyEvent.VK_RIGHT) return;
            ...
            if (ke.getKeyChar() == '*') {
                ...
                ke.consume();
                requestFocusOnNextField(target);
            } else if (ke.getKeyCode() == KeyEvent.VK_TAB || ke.getKeyCode() == KeyEvent.VK_SPACE || ke.getKeyCode() == KeyEvent.VK_ENTER) {
                requestFocusOnNextField(target);
        ...
        void requestFocusOnNextField(TextField target) {
            if (target == comp.fields[0]) comp.fields[1].requestFocus(); else if (target == comp.fields[1]) comp.fields[2].requestFocus(); else if (target == comp.fields[2]) comp.fields[3].requestFocus(); else if (target == comp.fields[3]) {
    ...
    class IPListener implements TextListener {
        ...
        public void textValueChanged(TextEvent e) {
            ...
            if (target == comp.fields[0]) comp.fields[1].requestFocus(); else if (target == comp.fields[1]) comp.fields[2].requestFocus(); else if (target == comp.fields[2]) comp.fields[3].requestFocus();
        }
   ...
   */
    ...
    private String getFieldValue(TextField field) {
        ...
        if (svalue.length() == 0) return "0"; else return svalue;
    }
   ...
   */
    public void setText(String IPT) {
        ...
        int i = 0;
        edu.hkust.clap.monitor.Monitor.loopBegin(960);
while (i < 4 && st.hasMoreTokens()) { 
edu.hkust.clap.monitor.Monitor.loopInc(960);
fields[i++].setText(st.nextToken());} 
edu.hkust.clap.monitor.Monitor.loopEnd(960);
   ...
   */
    ...
    public Dimension getMinimumSize() {
        return new Dimension(4 * fields[0].getMinimumSize().width, fields[0].getMinimumSize().height);
    }
    ...
    public IPTextField() {
        ...
        edu.hkust.clap.monitor.Monitor.loopBegin(961);
for (int i = 0; i < fields.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(961);
{
            fields[i] = new TextField(3);
            fields[i].addTextListener(iplistener);
            fields[i].addKeyListener(intlistener);
        }} 
edu.hkust.clap.monitor.Monitor.loopEnd(961);
