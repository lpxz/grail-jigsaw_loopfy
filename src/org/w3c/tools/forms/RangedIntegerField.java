...
class RangedIntegerFieldEditor extends Panel {
    ...
    public boolean action(Event evt, Object arg) {
        try {
            ...
            if (!field.acceptChange(ival)) text.setText(field.getValue().toString());
            return true;
...
public class RangedIntegerField extends IntegerField {
    ...
    public Component getEditor() {
        if (editor == null) editor = new RangedIntegerFieldEditor(this, lo, hi, getIntValue());
        return editor;
    }

    public RangedIntegerField(FormManager manager, String name, String title, int lo, int hi, int val) throws IllegalFieldValueException {
