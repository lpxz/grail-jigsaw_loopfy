...
class DoubleFieldEditor extends TextField {
    ...
    public boolean action(Event evt, Object arg) {
        ...
        if (oldval != null) setText(oldval.toString()); else setText("");
        return true;
    }
...
public class DoubleField extends FormField {
    ...
    public void setValue(Object value, boolean notify, boolean update) throws IllegalFieldValueException {
        if (!(value instanceof Double)) throw new IllegalFieldValueException(value);
     ...
     */
    public void setValue(Double value, boolean notify, boolean update) throws IllegalFieldValueException {
        this.value = value;
        if (update && (editor != null)) editor.setValue(value);
    ...
    public Component getEditor() {
        if (editor == null) editor = new DoubleFieldEditor(this, value);
        return editor;
    }
     ...
     */
    public DoubleField(FormManager manager, String name, String title, Double value) throws IllegalFieldValueException {
