...
class IntegerFieldEditor extends TextField {
    ...
    public boolean action(Event evt, Object arg) {
        try {
            ...
            if (!field.acceptChange(ival)) setText(field.getValue().toString());
            return true;
...
public class IntegerField extends FormField {
    ...
    public Component getEditor() {
        if (editor == null) editor = new IntegerFieldEditor(this, ival);
        return editor;
    }
     ...
     */
    public void setValue(Integer ival, boolean notify, boolean update) throws IllegalFieldValueException {
        this.ival = ival;
        if (update && (editor != null)) editor.setValue(ival);
    ...
    public void setValue(Object value, boolean notify, boolean update) throws IllegalFieldValueException {
        if (!(value instanceof Integer)) throw new IllegalFieldValueException(value);
        setValue((Integer) value, update);
    }

    public IntegerField(FormManager manager, String name, String title, Integer ival) {
        super(manager, name, title);
        this.ival = ival;
    }

    public IntegerField(FormManager manager, String name, String title, int value) {
