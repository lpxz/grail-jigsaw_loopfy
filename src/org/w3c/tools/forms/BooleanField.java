...
public class BooleanField extends OptionField {
    ...
    public void setValue(Object value, boolean notify, boolean update) throws IllegalFieldValueException {
        if (!(value instanceof Boolean)) throw new IllegalFieldValueException(value);
     ...
     * @exception IllegalFieldValueException If the field rejected the value.
     */
    public BooleanField(FormManager manager, String name, String title, boolean value) throws IllegalFieldValueException {
