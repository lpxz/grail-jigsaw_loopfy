...
public class CommandInterpreter {
    ...
    public CommandInterpreter(String[] args) {
        ...
        if (interactive) runInteractive(); else runScriptFile(args[2]);
    }
	...
	*/
    private void run() {
        edu.hkust.clap.monitor.Monitor.loopBegin(392);
while (true) { 
edu.hkust.clap.monitor.Monitor.loopInc(392);
try {
            if (interactive) {
...
edu.hkust.clap.monitor.Monitor.loopEnd(392);
