...
public class Message {
     ...
     * @param title The dialog title
     */
    public static void showErrorMessage(RemoteResourceWrapper rrw, String message, String title) {
     ...
     * @param title The dialog title
     */
    public static void showErrorMessage(Component parent, Exception ex, String title) {
     ...
     * @param title The dialog title
     */
    public static void showErrorMessage(RemoteResourceWrapper rrw, Exception ex, String title) {
     ...
     * @param ex the catched exception
     */
    public static void showErrorMessage(Component parent, RemoteAccessException ex) {
     ...
     * @param ex the catched exception
     */
    public static void showErrorMessage(RemoteResourceWrapper rrw, RemoteAccessException ex) {
     ...
     * @param ex the catched exception
     */
    public static void showErrorMessage(Component parent, Exception ex) {
     ...
     * @param ex the catched exception
     */
    public static void showErrorMessage(RemoteResourceWrapper rrw, Exception ex) {
     ...
     * @param title The dialog title
     */
    public static void showInformationMessage(RemoteResourceWrapper rrw, String message, String title) {
