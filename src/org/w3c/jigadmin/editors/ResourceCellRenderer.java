...
public class ResourceCellRenderer extends JLabel implements ListCellRenderer {
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        if (value instanceof ResourceCell) {
            ...
            if (cell.isContainer() || cell.isIndexer()) setIcon(Icons.dirIcon); else if (cell.isFrame()) setIcon(Icons.frameIcon); else if (cell.isFilter()) setIcon(Icons.filterIcon); else if (cell.isMetaDataFrame()) setIcon(Icons.metaDataIcon); else setIcon(Icons.resIcon);
        }
