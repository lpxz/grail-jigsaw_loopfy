...
public class RemoteResourceWrapperNode implements MutableTreeNode, RemoteNode {
    ...
    protected synchronized void loadChildren() {
        ...
        edu.hkust.clap.monitor.Monitor.loopBegin(807);
for (int i = 0; i < names.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(807);
{
            try {
            ...
            if (child != null) {
                RemoteResourceWrapperNode node = new RemoteResourceWrapperNode(this, child, names[i]);
                children.add(node);
            }
        }} 
edu.hkust.clap.monitor.Monitor.loopEnd(807);
     ...
     */
    protected RemoteResourceWrapperNode(RemoteResourceWrapperNode parent, RemoteResourceWrapper rrw, String name) {
        this.parent = parent;
        this.name = name;
        this.rrw = rrw;
    }
     ...
     * @param name The name of this node
     */
    protected RemoteResourceWrapperNode(RemoteResourceWrapper rrw, String name) {
        this.rrw = rrw;
        this.name = name;
    }
}
