...
public class SpaceServerHelper extends JDesktopPane implements ServerHelperInterface, ResourceActionListener {
    ...
    protected JInternalFrame getInternalFrame() {
        ...
        JInternalFrame frame = new JInternalFrame("Available Resources", true, false, true, true);
...
edu.hkust.clap.monitor.Monitor.loopEnd(235);
        ...
        tabbedPane.addTab("Frames", null, scroll, "Frames and Filters available");
    ...
    protected void updateLayout(int width, int height) {
        ...
        if (x < minx) iframe.setLocation(minx, 10);
    }
