...
public class ControlServerHelper extends JToolBar implements ServerHelperInterface, ResourceActionSource {
    ...
    ActionListener al = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (command.equals(HELP_A)) {
                try {
                    String url = (String) control.getResource().getValue("help-url");
    ...
    protected void fireResourceEvent(int type) {
        if (listeners == null) return;
        ResourceActionEvent ev = new ResourceActionEvent(this, type);
        edu.hkust.clap.monitor.Monitor.loopBegin(645);
for (int i = 0; i < listeners.size(); i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(645);
((ResourceActionListener) listeners.elementAt(i)).resourceActionPerformed(ev);} 
edu.hkust.clap.monitor.Monitor.loopEnd(645);
    ...
    protected void build() {
        ...
        if (saveBTT == null) saveBTT = "Save the configuration";
        ...
        if (stopBTT == null) stopBTT = "Stop the server";
        ...
        if (res_op_enabled) {
            ...
            if (reinBTT == null) reinBTT = "Reindex children of selected Container(s)";
            ...
            if (addBTT == null) addBTT = "Add a resource to the selected Container";
            ...
            if (deleBTT == null) deleBTT = "Delete selected resources";
            ...
            if (editBTT == null) editBTT = "Edit selected resource";
            ...
            if (refeBTT == null) refeBTT = "Show reference documentation of selected resource";
            ...
            if (helpBTT == null) helpBTT = "Show documentation";
