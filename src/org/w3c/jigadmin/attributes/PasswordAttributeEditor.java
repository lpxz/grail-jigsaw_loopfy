...
class PasswordEditor extends JPanel {
    ...
    ActionListener al = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getActionCommand().equals("Ok") || ae.getSource().equals(verify)) {
    ...
    public PasswordEditor(PasswordAttributeEditor pae, String name) {
        ...
        if (name != null) setBorder(BorderFactory.createTitledBorder("User: " + name));
...
public class PasswordAttributeEditor extends AttributeEditor {
    ...
    protected void setText(String s) {
        if (s.equals("")) {
            ...
            edu.hkust.clap.monitor.Monitor.loopBegin(176);
for (int i = 0; i < s.length(); i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(176);
c[i] = '*';} 
edu.hkust.clap.monitor.Monitor.loopEnd(176);
    ...
    public void initialize(RemoteResourceWrapper w, Attribute a, Object o, Properties p) throws RemoteAccessException {
        frame = ((org.w3c.jigadmin.RemoteResourceWrapper) w).getServerBrowser().getFrame();
