...
public class StringChoiceEditor extends AttributeEditor {
    ...
    class StringChoiceComponent extends StringChoice implements DocumentListener {
        ...
        protected void setTextInternal(String stext) {
            if (modifier != null) setText(modifier.modify(stext)); else setText(stext);
        }

        StringChoiceComponent(StringChoiceEditor editor, String selected, EditorFeeder feeder, EditorModifier modifier) {
            super();
            this.editor = editor;
            this.feeder = feeder;
    ...
    protected void createComponent(EditorFeeder feeder, EditorModifier modifier, String selected) {
        if (comp == null) comp = new StringChoiceComponent(this, selected, feeder, modifier);
    }
    ...
    public void initialize(RemoteResourceWrapper w, Attribute a, Object o, Properties p) throws RemoteAccessException {
        ...
        if (feederClass == null) throw new RuntimeException("StringChoiceEditor mis-configuration:" + FEEDER_CLASS_P + " property undefined.");
        try {
            ...
            ex.printStackTrace();
            throw new RuntimeException("StringChoiceEditor mis-configured: " + " unable to instantiate " + feederClass + ".");
        }
