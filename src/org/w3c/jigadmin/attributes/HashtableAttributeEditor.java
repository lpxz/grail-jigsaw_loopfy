        ...
        ActionListener al = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (command.equals("add")) {
                    ...
                    edu.hkust.clap.monitor.Monitor.loopBegin(1142);
for (int i = 0; i < sels.length; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(1142);
{
                        table.remove((String) sels[i]);
                        listdata.removeElement((String) sels[i]);
                    }} 
edu.hkust.clap.monitor.Monitor.loopEnd(1142);
        ...
        HashtableAttributePopup(HashtableAttributeComponent parent, ArrayDictionary table, Vector listdata, String title) {
    ...
    class HashtableAttributeComponent extends ListEditor {
        ...
        protected void edit() {
            ...
            HashtableAttributePopup popup = new HashtableAttributePopup(this, table, list, "Edit");
        ...
        protected void setTable(ArrayDictionary table) {
            ...
            listdata = new Vector();
            edu.hkust.clap.monitor.Monitor.loopBegin(1143);
while (keys.hasMoreElements()) { 
edu.hkust.clap.monitor.Monitor.loopInc(1143);
listdata.addElement((String) keys.nextElement());} 
edu.hkust.clap.monitor.Monitor.loopEnd(1143);
