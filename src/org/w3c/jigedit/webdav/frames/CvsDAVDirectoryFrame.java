...
public class CvsDAVDirectoryFrame extends DAVFrame {
    ...
    static {
        ...
        Class cls = null;
        try {
            cls = Class.forName("org.w3c.jigedit.webdav.frames" + ".CvsDAVDirectoryFrame");
        } catch (Exception ex) {
            ex.printStackTrace();
            System.exit(1);
        }
    ...
    public Reply delete(Request request) throws ProtocolException, ResourceException {
        ...
        if (method.equals("DELETE")) {
            ...
            error.setContent("DELETE is forbidden on CVS controlled" + " directories in this version of JigEdit");
