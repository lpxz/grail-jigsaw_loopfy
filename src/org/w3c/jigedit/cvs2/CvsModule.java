...
public class CvsModule {
     ...
     * @return an Object.
     */
    public static void setValue(ResourceContext ctxt, String name, Object value) {
    ...
    public static synchronized CvsDirectory getCvsManager(File directory, ResourceContext ctxt, Properties props) throws CvsException {
        CvsDirectory cvs = null;
        String cvsroot = (String) getValue(ctxt, CVSROOT);
        if (cvsroot != null) cvs = CvsDirectory.getManager(directory, props, null, cvsroot, null); else cvs = CvsDirectory.getManager(directory, props);
        return cvs;
    }
