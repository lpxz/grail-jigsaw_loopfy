...
public class LookupTable implements Cloneable, Serializable {
    ...
    private int contains(Object array[], int size, Object value) {
        ...
        edu.hkust.clap.monitor.Monitor.loopBegin(1064);
for (int i = 0; i < size; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(1064);
{
            if (array[i].equals(value)) return i;
        }} 
edu.hkust.clap.monitor.Monitor.loopEnd(1064);
    ...
    public synchronized String toString() {
        ...
        edu.hkust.clap.monitor.Monitor.loopBegin(1065);
for (int i = 0; i < count; i++) { 
edu.hkust.clap.monitor.Monitor.loopInc(1065);
{
            buffer.append("[" + keys[i] + "," + elements[i] + "]");
        }} 
edu.hkust.clap.monitor.Monitor.loopEnd(1065);
